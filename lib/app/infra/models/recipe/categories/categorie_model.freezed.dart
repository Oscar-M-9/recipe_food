...
class _$CategorieModelImpl implements _CategorieModel {
  ...
  @override
  String toString() {
    return 'CategorieModel(id: $id, name: $name, description: $description, created_at: $created_at, updated_at: $updated_at)';
  }
...
abstract class _CategorieModel implements CategorieModel {
  factory _CategorieModel(
      {final int? id,
      final String? name,
      final String? description,
      final DateTime? created_at,
      final DateTime? updated_at}) = _$CategorieModelImpl;
